...
| **Name**       | **Description**                                                                                                                                                                                                                                                                                                                                                                             |
|----------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Mode           | There  are two modes:  1.  Absolute: |New Value-Previous Value| whether it is greater than the dead zonevalue, if it is greater, it will be collected, if not, it will be ignored. 2.  Percent: |New Value - Previous Value| is greater than the deadband value *|Engineering Upper Limit - Engineering Lower Limit | /100, if greater, itwill be collected, otherwise, it will be ignored. |
